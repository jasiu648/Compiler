...
public class CSoftParser extends Parser {
	...
	public static final int
		RULE_type = 0, RULE_prog = 1, RULE_statement = 2, RULE_ident = 3, RULE_arrayElementAssign = 4, 
		RULE_assignment = 5, RULE_print_statement = 6, RULE_read_statement = 7, 
		RULE_arrayAssign = 8, RULE_expr = 9, RULE_condXorStm = 10, RULE_condStmAnd = 11, 
		RULE_condStmRel = 12, RULE_addExpr = 13, RULE_multExpr = 14, RULE_negFactor = 15, 
		RULE_factor = 16, RULE_ifStm = 17, RULE_blockIf = 18, RULE_whileL = 19, 
		RULE_blockWhile = 20, RULE_repeatStm = 21, RULE_repNum = 22, RULE_blockRepeat = 23, 
		RULE_function = 24, RULE_blockFun = 25, RULE_classDecl = 26, RULE_blockClass = 27, 
		RULE_method = 28, RULE_blockMethod = 29, RULE_methodType = 30, RULE_methodName = 31, 
		RULE_className = 32, RULE_methodCall = 33, RULE_classAssign = 34, RULE_parameters = 35, 
		RULE_parameter = 36, RULE_structDecl = 37, RULE_blockStruct = 38, RULE_structVarDecl = 39, 
		RULE_structAssign = 40, RULE_structFieldAssign = 41, RULE_structFieldAccess = 42, 
		RULE_arrayAccess = 43, RULE_funcCall = 44, RULE_arguments = 45, RULE_argument = 46, 
		RULE_funType = 47, RULE_funName = 48, RULE_structName = 49;
	private static String[] makeRuleNames() {
		return new String[] {
			"type", "prog", "statement", "ident", "arrayElementAssign", "assignment", 
			"print_statement", "read_statement", "arrayAssign", "expr", "condXorStm", 
			"condStmAnd", "condStmRel", "addExpr", "multExpr", "negFactor", "factor", 
			"ifStm", "blockIf", "whileL", "blockWhile", "repeatStm", "repNum", "blockRepeat", 
			...
			"funcCall", "arguments", "argument", "funType", "funName", "structName"
		};
	}
	...
	public final ProgContext prog() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 51866730622L) != 0)) {
				{
				{
				setState(102);
				statement();
	...
	public final ArrayElementAssignContext arrayElementAssign() throws RecognitionException {
		...
		enterRule(_localctx, 8, RULE_arrayElementAssign);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(137);
	...
	public final Read_statementContext read_statement() throws RecognitionException {
		...
		enterRule(_localctx, 14, RULE_read_statement);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(152);
	...
	public final ArrayAssignContext arrayAssign() throws RecognitionException {
		...
		enterRule(_localctx, 16, RULE_arrayAssign);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final CondXorStmContext condXorStm() throws RecognitionException {
		...
		enterRule(_localctx, 20, RULE_condXorStm);
		try {
			setState(180);
			_errHandler.sync(this);
	...
	public final CondStmAndContext condStmAnd() throws RecognitionException {
		...
		enterRule(_localctx, 22, RULE_condStmAnd);
		try {
			setState(187);
			_errHandler.sync(this);
	...
	public final CondStmRelContext condStmRel() throws RecognitionException {
		...
		enterRule(_localctx, 24, RULE_condStmRel);
		try {
			setState(194);
			_errHandler.sync(this);
	...
	public final NegFactorContext negFactor() throws RecognitionException {
		...
		enterRule(_localctx, 30, RULE_negFactor);
		try {
			setState(213);
			_errHandler.sync(this);
			switch (_input.LA(1)) {
	...
	public final IfStmContext ifStm() throws RecognitionException {
		...
		enterRule(_localctx, 34, RULE_ifStm);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(226);
	...
	public final BlockIfContext blockIf() throws RecognitionException {
		...
		enterRule(_localctx, 36, RULE_blockIf);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final WhileLContext whileL() throws RecognitionException {
		...
		enterRule(_localctx, 38, RULE_whileL);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(240);
	...
	public final BlockWhileContext blockWhile() throws RecognitionException {
		...
		enterRule(_localctx, 40, RULE_blockWhile);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final RepeatStmContext repeatStm() throws RecognitionException {
		...
		enterRule(_localctx, 42, RULE_repeatStm);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(254);
	...
	public final RepNumContext repNum() throws RecognitionException {
		...
		enterRule(_localctx, 44, RULE_repNum);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(262);
	...
	public final BlockRepeatContext blockRepeat() throws RecognitionException {
		...
		enterRule(_localctx, 46, RULE_blockRepeat);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final BlockFunContext blockFun() throws RecognitionException {
		...
		enterRule(_localctx, 50, RULE_blockFun);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final BlockClassContext blockClass() throws RecognitionException {
		...
		enterRule(_localctx, 54, RULE_blockClass);
		int _la;
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
	...
	public final BlockMethodContext blockMethod() throws RecognitionException {
		...
		enterRule(_localctx, 58, RULE_blockMethod);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final ClassAssignContext classAssign() throws RecognitionException {
		...
		enterRule(_localctx, 68, RULE_classAssign);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(332);
	...
	public final BlockStructContext blockStruct() throws RecognitionException {
		...
		enterRule(_localctx, 76, RULE_blockStruct);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final StructVarDeclContext structVarDecl() throws RecognitionException {
		...
		enterRule(_localctx, 78, RULE_structVarDecl);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(359);
	...
	public final StructAssignContext structAssign() throws RecognitionException {
		...
		enterRule(_localctx, 80, RULE_structAssign);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(361);
	...
	public final StructFieldAssignContext structFieldAssign() throws RecognitionException {
		...
		enterRule(_localctx, 82, RULE_structFieldAssign);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(366);
	...
	public final StructFieldAccessContext structFieldAccess() throws RecognitionException {
		...
		enterRule(_localctx, 84, RULE_structFieldAccess);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(372);
	...
	public final FunTypeContext funType() throws RecognitionException {
		...
		enterRule(_localctx, 94, RULE_funType);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(398);
	...
	public final FunNameContext funName() throws RecognitionException {
		...
		enterRule(_localctx, 96, RULE_funName);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(400);
